...
# Listings
  ...
  USERS.each.with_index do |user, idx|
    file = EzDownload.open("https://s3-us-west-1.amazonaws.com/bookbnb-dev1/users/host#{idx}.jpeg")
  ...
  LISTINGS.each.with_index do |lst, idx1|
    (1..5).each do |idx2|
      file = EzDownload.open("https://s3-us-west-1.amazonaws.com/bookbnb-dev1/lst#{idx1 + 1}/lst#{idx1 + 1}-#{idx2}.jpeg")
