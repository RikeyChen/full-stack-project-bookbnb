  ...
  render() {
    ...
    return (
      <div className="listings-index-master">
        <ListingsIndexSidebar updateFilter={this.props.updateFilter} updateFilter2={this.props.updateFilter2} maxPrice={this.props.maxPrice} clearFilters={this.props.clearFilters} />
